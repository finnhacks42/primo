...
double rightOvershoot = 15;
double leftOvershoot = 15;
int state;
...
#define KI .1
#define KD .1
AutoPID speedPID(&angle, &setPoint, &speedDifference, -20, 20 , KP, KI, KD);
...
float angle_diff(float a1, float a2) {
  // returns a result between -180 and 180
  float result = a1 - a2;
...
float read_heading(){
  ...
  //if ((last_heading < 1000) & (abs(angle_diff(last_heading,heading)) > 30) & (skipped < 10)){
  //  heading = 1024;
  //  skipped +=1;
  //} else {
